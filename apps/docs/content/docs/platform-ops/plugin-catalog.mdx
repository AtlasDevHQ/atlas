...
Navigate to **Platform > Plugin Catalog** (`/platform/plugins`). The page shows a table of all catalog entries with columns for plugin name, type, minimum plan, enabled status, and creation date.
