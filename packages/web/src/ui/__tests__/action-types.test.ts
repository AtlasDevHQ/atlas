/**
 * `ui/lib/action-types` — the action-result guard and the status sets, plus
 * the approval card's local helpers.
 *
 * Merged 2026-09-04; formerly also action-approval-helpers.test.ts.
 */
...
/* ------------------------------------------------------------------ */
/*  RESOLVED_STATUSES — the literal terminal-status names               */
/* ------------------------------------------------------------------ */
