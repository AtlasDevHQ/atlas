...
- [x] **Post-1.5.0 proactive listener wiring** (parent #2607, 11 PRs + 3 follow-up PRs, closed 2026-05-19) — `@useatlas/chat` listener wired into SaaS deploy + Slack `@mention`/thread migrated off `slack.ts`; dogfood-verified in `#sandbox-atlas`. Same-day follow-ups #2622/#2624/#2633 shipped; remaining trail: #2623 polish, #2638/#2641 (PR-review surfaces), #2634/#2635 in #49.
