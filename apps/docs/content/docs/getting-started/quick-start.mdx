---
title: Quick Start
description: Get Atlas running locally in under 5 minutes.
---
...
> For a larger, production-like dataset, use `bun run atlas -- init --demo cybersec` instead. This loads a 62-table cybersecurity SaaS database (~500K rows) with realistic tech debt patterns. See [Demo Datasets](/docs/getting-started/demo-datasets) for all available demos.
