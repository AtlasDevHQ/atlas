...
The Chat SDK bridge plugin provides the same Teams functionality plus multi-platform support (Slack, Discord, etc.) and built-in state management. See the [migration guide](#migrating-to-useatlaschat) below.
</Callout>
