...
<Callout>
For detailed endpoint documentation with request/response schemas, see the **[interactive API Reference](/docs/api-reference/chat/chatStream)**, auto-generated from the OpenAPI specification.
</Callout>
