...
|-----------|-------|----------------|
| Nuxt (Vue) | [Nuxt](/frameworks/nuxt) | `@ai-sdk/vue` |
| SvelteKit | [SvelteKit](/frameworks/sveltekit) | `@ai-sdk/svelte` |
| React (Vite) | [React/Vite](/frameworks/react-vite) | `@ai-sdk/react` |
| TanStack Start | [TanStack Start](/frameworks/tanstack-start) | plain `fetch` / TanStack Query |
