...
- **Line count:** ~700 lines of new code (3 guards + tests + 1 helper module + docs + win-extension entry). The pattern reuse means the per-guard cost is small — each new guard adds ~50 lines including its dedicated test pair.
