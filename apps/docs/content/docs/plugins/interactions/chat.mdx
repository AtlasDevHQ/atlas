...
Stable adapters are bundled as dependencies of `@useatlas/chat` — no separate install needed. Additional platforms (Discord, Google Chat, Telegram, WhatsApp) are planned and will be supported as Chat SDK adapters are published.
