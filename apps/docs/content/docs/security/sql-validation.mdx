...
All queries — successful and failed — are recorded in the [audit log](/deployment/authentication#audit-logging) with user attribution, timing, and error details. Use the Admin > Audit Log page to review query patterns and identify suspicious activity.
