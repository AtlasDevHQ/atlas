 ...
 *   Always present. Retained so per-connection invalidation falls out as a
 *   filter over an org's entries, and so external backends (Redis, Memcached)
 *   can tag entries by connection.
 */
