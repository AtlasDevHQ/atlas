...
<Cards>
  <Card
    ...
    description="Open the hosted demo at app.useatlas.dev/demo and ask any of the canonical NovaMart questions — GMV, top categories, return reasons. An email, no account, no install."
  />
  <Card
