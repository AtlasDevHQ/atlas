...
Suite sizes: **promotion-pg.test.ts** 49 tests (`src/lib/brain/__tests__/promotion-pg.test.ts`) · **identity-consumers-pg.test.ts** 76 tests (`src/lib/brain/__tests__/identity-consumers-pg.test.ts`).
