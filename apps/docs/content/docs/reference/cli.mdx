---
title: CLI Reference
description: Complete reference for the Atlas CLI — init, diff, index, learn, query, doctor, validate, mcp, completions, and more.
---
...
- [Schema Evolution](/guides/schema-evolution) — Detecting database drift with `atlas diff` and updating entity YAMLs
