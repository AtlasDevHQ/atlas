...
After configuring any datasource, generate the YAML files the agent reads before writing queries:
...
<Callout type="info">
For a comprehensive guide on how the agent routes queries across datasources, semantic layer organization per source, cross-source relationships, and troubleshooting, see [Multi-Datasource Routing](/guides/multi-datasource).
</Callout>
...
- [Multi-Datasource Routing](/guides/multi-datasource) — Connect multiple databases in a single deployment
