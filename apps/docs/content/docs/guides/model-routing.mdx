...
<Callout type="info" title="SaaS Feature">
  Model routing is available on [app.useatlas.dev](https://app.useatlas.dev) Enterprise plans. Self-hosted deployments configure the model provider globally via environment variables.
</Callout>
...
Model routing requires an active Enterprise plan on [app.useatlas.dev](https://app.useatlas.dev). Contact support if you see this error on an Enterprise workspace.
