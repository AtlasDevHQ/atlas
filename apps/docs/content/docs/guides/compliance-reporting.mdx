...
Compliance reporting is included with Enterprise plans on [app.useatlas.dev](https://app.useatlas.dev). Contact your account team to enable it, or visit **Admin > Billing** to upgrade.
</Callout>
...
- [Audit logging](/guides/audit-retention) active (queries must be logged to generate reports)
</Callout>

<Callout type="info" title="Self-hosted prerequisites">
