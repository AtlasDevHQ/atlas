...
**Actions:**
- **Add connection** — Opens a form to register a new datasource (connection ID, database type, connection URL, optional schema and description). You can test the URL before saving
