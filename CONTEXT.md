...
> multi-context layout ([CONTEXT-MAP.md](CONTEXT-MAP.md)); twelve of its eighteen contexts
...
>
> They were moved, not copied: no section below duplicates them. The remaining six
