...
- [Managed auth](/self-hosted/deployment/authentication#managed-auth-self-hosted-setup) enabled (`ATLAS_AUTH_MODE=managed`)
...
See [Social Providers](/self-hosted/guides/social-providers) for detailed OAuth setup
...
- [Social Providers](/self-hosted/guides/social-providers) — Detailed OAuth setup per provider
