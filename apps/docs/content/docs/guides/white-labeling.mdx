...
White-labeling lets enterprise customers remove Atlas branding and replace it with their own identity — custom logo, colors, favicon, and text — in the admin console.
...
<Callout type="info">
Chat UI and embedded widget branding integration is planned. The public branding endpoint (`GET /api/v1/branding`) is already available for custom integrations.
</Callout>
