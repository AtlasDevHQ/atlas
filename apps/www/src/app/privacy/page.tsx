...
const SECTIONS: LegalSectionData[] = [
  ...
  },
  {
    ...
    plain:
      "TLS 1.2+ in transit, AES-256-GCM at rest with versioned key rotation, two-factor (TOTP or passkey) required for admin accounts, and automated vulnerability scanning of both our dependencies and the container images we ship. We do not hold SOC 2 Type II or ISO 27001 certification today, and we don’t claim controls we haven’t built — certification, a documented incident-response runbook, and third-party penetration testing are all on the roadmap, not in place. Report suspected issues to security@useatlas.dev (PGP key at useatlas.dev/.well-known/atlas-security.asc).",
  },
  {
    id: "cookies",
