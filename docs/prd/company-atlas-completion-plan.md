...
5. **Lane E grill** — before anything is filed into [#101](https://github.com/AtlasDevHQ/atlas/milestone/101). #5332 is closed, but what it revealed — live, unexamined M6 mechanism — is what the grill is for.
