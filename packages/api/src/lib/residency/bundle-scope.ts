...
export const BUNDLE_TABLE_DECISIONS = {
  ...
  brain_facts: { decision: "exported", reason: "Company brain tier-2 (ADR-0036) — the workspace's reviewed knowledge, same asset class as the KB. Provenance, BOTH grants, review status and all four temporal columns travel with the claim; a fact stripped of any of them would land unprovenanced and ungated. Both grants because `visible_to` gates the claim and `pre_widening_visible_to` gates its attribution (#4836) — carrying only the first lands every widened fact reading as never-widened, which discloses in full." },
