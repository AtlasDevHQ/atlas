...
export async function postMessage(
  ...
  return slackAPI("chat.postMessage", token, params as Record<string, unknown>, log);
}
...
export async function updateMessage(
  ...
  return slackAPI("chat.update", token, params as Record<string, unknown>, log);
}
...
export async function postEphemeral(
  ...
  return slackAPI("chat.postEphemeral", token, params as Record<string, unknown>, log);
}
