...
- [ ] **Slice 6 — expansion targets** ([#2930](https://github.com/AtlasDevHQ/atlas/issues/2930), HITL) — stripe-data + 2 REST candidates thin-wrapping the primitive. Split into 6a/6b/6c:
  ...
  - [ ] **6b — notion-data thin wrapper** ([#3029](https://github.com/AtlasDevHQ/atlas/issues/3029)) — bearer + required `Notion-Version` header.
  - [ ] **6c — OAuthDatasourceInstallHandler + github-data** ([#3030](https://github.com/AtlasDevHQ/atlas/issues/3030)) — OAuth2 install path (resolves OQ5).
