...
| **Custom domain** | — | ✓ | ✓ | N/A |
| **SSO / SCIM** | — | — | ✓ | N/A |
| **Data residency (US; EU/APAC on request)** | ✓ | ✓ | ✓ | N/A |
...
- **Business** — Unlimited seats and connections. Includes SSO and SCIM. Atlas Cloud does not publish a numeric availability SLA on any plan; where one is required, it is agreed in the order form rather than committed here.
