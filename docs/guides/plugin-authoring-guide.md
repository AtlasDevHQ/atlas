...
The ClickHouse plugin tests ([`plugins/clickhouse/__tests__/clickhouse.test.ts`](../plugins/clickhouse/__tests__/clickhouse.test.ts)) demonstrate the canonical test pattern. Key sections:
