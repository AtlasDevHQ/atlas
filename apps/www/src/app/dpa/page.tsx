          ...
          <div className="mb-8 flex flex-col items-start gap-6 lg:flex-row lg:items-end lg:justify-between lg:gap-10">
            <div>
              ...
              <p className="mt-3 max-w-xl text-sm text-fg-muted">
                ...
                are listed — once they&rsquo;re available to you. One we&rsquo;ve
                built but not released yet receives nothing, so it joins this
                list when it ships, with the same 30 days&rsquo; notice.
              </p>
            </div>
