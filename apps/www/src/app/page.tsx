        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <p className="mb-6 text-sm leading-relaxed text-zinc-400">
            ...
            <ul className="mb-8 space-y-3">
              ...
              <DeploymentFeature>Data residency & custom domains</DeploymentFeature>
          ...
          <div className="grid gap-3 sm:grid-cols-2 md:grid-cols-3">
            {[
              ...
              },
              {
                ...
                detail: "Bot Framework, Adaptive Cards, OAuth connect flow",
                icon: (
                  <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              {
                name: "Email",
                detail: "SMTP, Resend, or Postmark — BYOT provider support",
                icon: (
                  <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              {
                name: "Google Chat",
                detail: "Service account webhooks with threaded replies",
                icon: (
                  <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              {
                name: "Telegram",
                detail: "Bot API with conversation threads and rich messages",
                icon: (
                  <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              {
                name: "More channels",
                detail: "GitHub, Linear, WhatsApp, Jira, webhooks",
                icon: (
                  <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
