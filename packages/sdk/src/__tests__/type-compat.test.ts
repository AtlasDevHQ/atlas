...
import type {
  ...
  ConnectionHealth as APIConnectionHealth,
  ConnectionInfo as APIConnectionInfo,
  ConnectionDetail as APIConnectionDetail,
} from "@atlas/api/lib/connection-types";
import type {
  Conversation, Message, ConversationWithMessages, ActionApprovalMode,
  DBType, HealthStatus, ConnectionHealth, ConnectionInfo, ConnectionDetail,
} from "../client";
...
const _dbTypeCompat: AssertAssignable<DBType, APIDBType> = true;
const _healthStatusCompat: AssertAssignable<HealthStatus, APIHealthStatus> = true;
const _connHealthCompat: AssertAssignable<ConnectionHealth, APIConnectionHealth> = true;
const _connInfoCompat: AssertAssignable<ConnectionInfo, APIConnectionInfo> = true;
const _connDetailCompat: AssertAssignable<ConnectionDetail, APIConnectionDetail> = true;
...
void _dbTypeCompat;
void _healthStatusCompat;
void _connHealthCompat;
void _connInfoCompat;
void _connDetailCompat;
