...
- [x] Phase 1 — Audit Better Auth config + middleware coverage (#1720, PR #1734). All P0/P1/P2 findings fixed: F-01 → PR #1738 (+ #1742 for dashboards twin #1736, + #1749 for DB invariant #1737 which also revokes drifted share_tokens); F-02 → PR #1735; F-03 → PR #1744; F-04 → PR #1748; F-05 bundled into F-06; F-06 → PR #1739; F-07 → PR #1747. Follow-ups shipped in milestone: share-token redaction (#1743 → PR #1771, F-01 cluster hardening), Better Auth rate-limit integration test (#1741 → PR #1793, F-06 wiring coverage — extracted `buildAuthOptions(deps)` helper + three-test pack: config wiring snapshot, live 10×401/1×429 loop, signup enumeration parity; surfaced incidental P3 #1792 for upstream `image: null` asymmetry)
