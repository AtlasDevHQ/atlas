...
Three queued milestones — none active. Next-up decision lives in `/next`.

- **1.4.4 — Multi-environment semantic layer** ([milestone #45](https://github.com/AtlasDevHQ/atlas/milestones/45), 11 issues) — PRD #2336 + connection-groups foundation (#2339), group-scoped semantic / PII / dashboards / scheduled-tasks / approvals (#2340–#2344), group-aware chat routing (#2345), legacy `connection_id` deprecation (#2346/#2347). Spawned from the #2329 audit.
