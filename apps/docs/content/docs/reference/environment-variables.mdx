...
| Variable | Default | Description |
|----------|---------|-------------|
| `ATLAS_EMAIL_PROVIDER` | `resend` | Platform email provider: `resend`, `sendgrid`, `postmark`, `smtp`. Primarily configured via Admin > Settings, but falls back to this env var |
