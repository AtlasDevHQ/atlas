...
> ⚠️ **SUPERSEDED as a status report, kept as a record of the starting position.** Live status is the [Finish Conditions board](https://github.com/orgs/AtlasDevHQ/projects/3). At least two rows below are now false.
>
