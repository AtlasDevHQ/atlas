...
**Aggregation types:** `count_distinct`, `sum`, `avg`, `min`, `max`, `count_where`
...
<WhenSaaS>
- [Hosted Quick Start](/getting-started/hosted) — sign up, connect your database, and start querying
</WhenSaaS>
