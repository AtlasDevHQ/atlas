...
// breaks under bun 1.3.14 --isolate (62/0 bare → 5/57 isolate). pair-6/-7
// already proved the mock.module() side propagates fine; the smoking gun
// is the conditional-mount: `src/api/index.ts:251` checks the env at top
// level and only mounts the actions route when set. Under --isolate the
// env doesn't make it to the dynamically-imported child module.
//
