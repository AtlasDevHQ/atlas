...
const TIERS: Tier[] = [
  {
    ...
    cta: "Deploy now",
    ctaHref: "https://docs.useatlas.dev/self-hosted/getting-started/quick-start",
...
const FAQS: FAQ[] = [
  {
    ...
    answer:
      "An AI query is one round-trip where Atlas generates and executes SQL against your database. Browsing the admin console, viewing dashboards, or editing the semantic layer does not consume queries. Only AI-generated SQL executions count.",
  },
  {
