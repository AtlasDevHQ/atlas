...
| `ATLAS_EMAIL_ALLOWED_RECIPIENT_DOMAINS` | ⚪ | Optional; `StagingClamp` already clamps recipients. Unset = workspace members only, and since #4663 this is the recipient gate's only domain source. |
