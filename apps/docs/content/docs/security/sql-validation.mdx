...
- [Row-Level Security](/docs/security/row-level-security) -- automatic WHERE clause injection based on user claims (Layer 4)
- [Connect Your Data](/docs/getting-started/connect-your-data#safety-knobs) -- configuring row limits, query timeouts, and table whitelists
