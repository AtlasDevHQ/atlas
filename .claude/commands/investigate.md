---
description: "Research an untracked bug, tech-debt item, or idea, file a GitHub issue, decide fix-now vs park. One-issue-sized only — /elevate for a whole surface, /to-spec for a milestone."
---
...
- **Milestone-sized direction or architectural change** — stop and use `/to-spec` instead; it synthesises the conversation into a PRD issue that `/to-tickets` can then break into vertical slices
