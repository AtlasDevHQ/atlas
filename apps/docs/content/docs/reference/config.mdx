...
<Callout type="info">
Enterprise features include SSO (SAML/OIDC), SCIM provisioning, PII detection, custom roles, and advanced audit capabilities. The AGPL-licensed core is fully functional without enterprise features enabled.
</Callout>
