...
Model routing requires an active Business plan on [app.useatlas.dev](https://app.useatlas.dev). Contact support if you see this error on an Enterprise workspace.
