...
The widget handles errors automatically with contextual UI. This section documents what happens for each error type and how to listen for errors from your host page.
