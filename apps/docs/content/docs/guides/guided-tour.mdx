---
title: Guided Tour
description: In-app walkthrough that introduces new users to chat, admin, and semantic layer features.
---

import { Callout } from "fumadocs-ui/components/callout";

The guided tour is an interactive overlay that walks new users through Atlas's key features. It highlights three areas of the interface — chat, admin console, and semantic layer — with tooltips explaining each one.
...
| 2 | Admin console | Manage connections, users, roles, and monitor usage (**admin-only** — skipped for non-admin users) |
| 3 | Semantic layer | Entity definitions, metrics, and glossary terms that help Atlas understand your data |

Non-admin users see 2 steps (the admin console step is filtered out automatically).
