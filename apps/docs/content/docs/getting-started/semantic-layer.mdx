...
- [Key Concepts](/getting-started/concepts) — Definitions of entities, dimensions, measures, joins, and metrics
- [Schema Evolution](/guides/schema-evolution) — Detect database drift and update your semantic layer
