...
export async function importBundle(
  ...
  for (const entity of bundle.semanticEntities) {
    ...
    await client.query(
      `INSERT INTO semantic_entities (org_id, entity_type, name, yaml_content, connection_id, connection_group_id)
       VALUES ($1, $2, $3, $4, $5, $6)`,
      [orgId, entity.entityType, entity.name, entity.yamlContent, entity.connectionId, entity.connectionGroupId ?? null],
    );
