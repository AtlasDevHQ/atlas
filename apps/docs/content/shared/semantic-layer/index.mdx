...
These five questions — drawn from the [NovaMart demo dataset](/getting-started/demo-datasets) — exercise the full surface of the YAML format. They're the same questions the docs introduction, the landing page, and the eval harness all reference.
