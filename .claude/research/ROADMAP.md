...
- **`v0.0.3` — Spec Lifecycle** ([milestone #58](https://github.com/AtlasDevHQ/atlas/milestone/58)) — successor to v0.0.2, split out per [#3013](https://github.com/AtlasDevHQ/atlas/issues/3013). Keeps an OpenAPI datasource's view current after install. 3 of 5 shipped: refresh interval ([#2977](https://github.com/AtlasDevHQ/atlas/issues/2977), shipped [#3002](https://github.com/AtlasDevHQ/atlas/pull/3002)), structured drift diff ([#2976](https://github.com/AtlasDevHQ/atlas/issues/2976), shipped [#3041](https://github.com/AtlasDevHQ/atlas/pull/3041)), shared cross-workspace spec/graph cache ([#2970](https://github.com/AtlasDevHQ/atlas/issues/2970), shipped [#3042](https://github.com/AtlasDevHQ/atlas/pull/3042)). Remaining: scheduler-driven auto re-discovery ([#2978](https://github.com/AtlasDevHQ/atlas/issues/2978)) + breaking-change signal ([#2979](https://github.com/AtlasDevHQ/atlas/issues/2979)).
