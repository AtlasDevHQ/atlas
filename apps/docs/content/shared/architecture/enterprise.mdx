...
- Dashboards, sharing, embedding widget
...
See [Environment Variables](/reference/environment-variables#enterprise) for the full env-var schema.
...
- [Comparisons: Metabase](/comparisons/metabase#licensing) — split-license positioning vs other AGPL BI tools
