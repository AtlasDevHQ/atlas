...
See the [Cross-Environment Scope](/deployment/multi-datasource#cross-environment-scope-routing-145) guide for the partial-failure rendering pattern and the conversation-routing semantics.
