...
- [Row-Level Security](/docs/security/row-level-security) -- automatic data isolation per tenant using JWT claims
- [Actions Framework](/docs/guides/actions) -- approval-gated write operations (requires auth)
- [Troubleshooting](/docs/guides/troubleshooting#auth-issues) -- common auth errors and fixes
