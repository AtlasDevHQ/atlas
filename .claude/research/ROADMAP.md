...
- [x] Per-client rate-limit hardening — deferred items from C1 review ([#2183](https://github.com/AtlasDevHQ/atlas/issues/2183), [PR #2215](https://github.com/AtlasDevHQ/atlas/pull/2215)) — burst-credit policy, per-tool weight overrides, and audit-shape gaps from the #2180 review thread.
