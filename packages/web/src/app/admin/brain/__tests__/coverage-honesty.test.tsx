...
// ---------------------------------------------------------------------------
// Merged from coverage-plate.test.tsx (#5422) — same source module
// (`../page`, the Company Atlas coverage surface) and a byte-identical
// harness (next/navigation mock, AtlasProvider wrapper, fetch stub,
// beforeEach/afterEach). Its `loaded()` is `loadedPlate()` here: it waits on
// the plate marker, the suite above waits on the composed statement.
// ---------------------------------------------------------------------------
