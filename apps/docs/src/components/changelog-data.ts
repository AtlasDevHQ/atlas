...
export const releases: Release[] = [
  {
    ...
    highlights: [
      ...
      "Pre-customer posture, clean breaks — no migration shim for the legacy `INSERT INTO connections` path; the `connections` table is dropped in one go. Test mocks migrate to `encryptSecretFields` rather than `encryptUrl` stubs",
    ],
    githubMilestone: 51,
  },
  {
