/**
 * chart-detection.ts — column classification, chart recommendation, data
 * transform, click mapping, and the reference-line resolvers.
 *
 * Merged 2026-09-04: formerly also
 * src/ui/components/chart/__tests__/thresholds.test.ts (#3208) and
 * src/ui/components/chart/__tests__/annotations.test.ts (#3209).
 */
