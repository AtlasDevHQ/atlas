...
// Brand at the test boundary — `PendingAnswers.record/peek/consume`
// take {@link ThreadId}, so bare strings would be compile errors
// (#2680).
const T1 = assertThreadId("slack:C-allowed:1700000000.000001");
const T2 = assertThreadId("slack:C-other:1700000000.000002");
