...
Drop this into long-description fields verbatim or trim to fit the form's word count. Pair with the catalog tool annotations at [`apps/docs/content/shared/architecture/mcp-tool-annotations.mdx`](../../../../apps/docs/content/shared/architecture/mcp-tool-annotations.mdx) for the per-tool entries on MCP catalog forms.
