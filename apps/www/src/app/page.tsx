      ...
      <section className="mx-auto max-w-5xl px-6 pt-24 pb-20 md:pt-36 md:pb-28">
        <div className="max-w-3xl">
          <p className="animate-fade-in-up delay-100 mb-5 font-mono text-sm tracking-wide text-brand">
            Open-source text-to-SQL for every app
          </p>
          ...
          <p className="animate-fade-in-up delay-300 mt-6 max-w-xl text-lg leading-relaxed text-zinc-400">
            Connect any database, auto-generate a semantic layer, and let
            your users query data in plain English. Embed in your app with
            one script tag.
          </p>
        ...
        <div className="grid gap-px overflow-hidden rounded-xl border border-zinc-800/60 bg-zinc-800/40 sm:grid-cols-2 md:grid-cols-3">
          {[
            ...
            },
            {
              ...
              description:
                "Docker, Railway, or Vercel. Ship a full-stack app or a headless API. One command to scaffold.",
            },
            {
              icon: (
                <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            },
            {
              ...
              description:
                "Auto-generated charts from query results. Bar, line, area, pie — rendered inline in the chat.",
            },
            {
              icon: (
                <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
