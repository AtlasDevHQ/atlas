...
- **Chat polish** — Dark/light mode toggle with persistence, admin-configurable brand color, suggested follow-up questions, data export (CSV/Excel), mobile-responsive layout, saved queries
