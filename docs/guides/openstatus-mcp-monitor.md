...
- Hosted MCP guide (user-facing): [`apps/docs/content/shared/guides/mcp.mdx`](../../apps/docs/content/shared/guides/mcp.mdx) — "Operational notes" section under "Hosted protocol reference"
