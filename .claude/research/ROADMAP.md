...
- [ ] Consolidate duplicated fetch logic between `@useatlas/react` and `packages/web` hooks (#1505 — now unblocked by #1504; both hooks encode the same 5xx soft-fail / 4xx throw discipline; extract to SDK or types)
