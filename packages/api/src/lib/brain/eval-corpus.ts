 ...
 *
 * ⚠️ Emails FIRST, then mentions. Reversed, the mention pattern eats the
 * local-part-then-`@` of an address (`ping @dev` and `dev@apache.org` overlap
 * on the `@`), leaving a half-rewritten address that is still resolvable and no
