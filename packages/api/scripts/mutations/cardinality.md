...
Suite sizes: **cardinality-pg.test.ts** 28 tests (`src/lib/brain/__tests__/cardinality-pg.test.ts`) · **cardinality.test.ts** 49 tests (`src/lib/brain/__tests__/cardinality.test.ts`) · **correction.test.ts** 88 tests (`src/lib/brain/__tests__/correction.test.ts`) · **brain-facts.test.ts** 63 tests (`src/lib/content-mode/adapters/__tests__/brain-facts.test.ts`) · **reconcile.test.ts** 81 tests (`src/lib/brain/__tests__/reconcile.test.ts`).
