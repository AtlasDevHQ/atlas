...
| | Atlas | Metabase |
|---|---|---|
| **License** | MIT | AGPL-3.0 (Pro/Enterprise is proprietary) |
...
Atlas is **MIT** with no proprietary tiers. All features are available in the open-source version.
...
<Callout type="info">
  If embedding is important to your use case, note that Metabase requires a paid license for interactive embedding, while Atlas's embedding is available under MIT.
</Callout>
