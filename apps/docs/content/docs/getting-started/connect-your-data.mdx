...
For multi-tenant deployments, enable [Row-Level Security](/docs/security/row-level-security) to automatically filter queries by tenant based on user claims.
