...
export const milestones: Milestone[] = [
  ...
  // ── Current ──────────────────────────────────────────────
  {
    ...
    status: "current",
    summary:
      "Public launch of hosted Atlas at app.useatlas.dev. Core launch infrastructure complete — pricing, SLA commitments, legal pages (ToS, privacy, DPA), migration tooling, hosted user docs, OpenStatus incident management, and status page all shipped.",
    highlights: [
      "SLA page with uptime guarantees, latency targets, and support tiers",
      "Terms of Service, Privacy Policy, and DPA at useatlas.dev",
      "Hosted getting-started guide and workspace admin docs",
      "Migration tooling — atlas export/import for self-hosted to SaaS",
      "OpenStatus integration for incident management",
      "Regional API — 3 regions live (US, EU, APAC) with misrouting detection",
      "Social media launch content — Twitter thread and LinkedIn post",
    ],
    githubMilestone: 24,
  },
];
