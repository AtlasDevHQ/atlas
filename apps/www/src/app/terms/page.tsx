...
const SECTIONS: LegalSectionData[] = [
  ...
  },
  {
    ...
    title: "Fees & Payment",
    legal: [
      "Customer agrees to pay all fees stated in the order form or on the pricing page in effect at the time of purchase. Fees are exclusive of taxes; Customer is responsible for sales, use, VAT, and similar taxes. Atlas Cloud paid plans include a 14-day free trial; trial accounts are provided without support obligation or liability — see Sections 8 and 9. Atlas does not publish a numeric availability commitment for any plan, and none is implied by a paid subscription; where a service level is required it is agreed in an order form signed by both parties. The 14-day trial clock begins when the account is claimed (email verified and credentials set). A workspace provisioned but never claimed runs on a short grace window and expires automatically when that window elapses. Signup is limited to business email addresses.",
