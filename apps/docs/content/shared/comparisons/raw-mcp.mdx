...
| **Admin console** | None | Connections, users, plugins, semantic editor, analytics, billing |
| **Chat integrations** | None | 8 integrations via Chat SDK (Slack, Teams, Discord, Telegram, Google Chat, GitHub, Linear, WhatsApp) |
| **Data residency** | None | Hosted in the US; EU and APAC regions are built and brought online on request |
