    ...
    <div className="relative min-h-screen">
        ...
        <div className="grid gap-px overflow-hidden rounded-xl border border-zinc-800/60 bg-zinc-800/40 sm:grid-cols-2 md:grid-cols-3">
          {[
            ...
            },
            {
              ...
              title: "Multi-Tenancy",
              description:
                "Organization-scoped semantic layers, connection pools, and caching via Better Auth. Full data isolation per tenant.",
            },
            {
              icon: (
                <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              title: "Query Caching",
              description:
                "Configurable TTL caching for query results with admin flush controls and per-organization isolation.",
            },
            {
              icon: (
                <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <section className="mx-auto max-w-5xl px-6 py-20 md:py-28">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {/* Self-hosted */}
          <div className="rounded-xl border border-zinc-800/60 bg-zinc-900/30 p-8 md:p-10">
          ...
          {/* Atlas Cloud */}
          <div className="cloud-glow rounded-xl bg-zinc-900/50 p-8 md:p-10">
            <div className="mb-2 flex items-center gap-3">
        ...
        <div className="grid gap-px overflow-hidden rounded-xl border border-zinc-800/60 bg-zinc-800/40 sm:grid-cols-2 md:grid-cols-3">
          {[
            ...
            },
            {
              ...
              description:
                "Bot Framework integration with Adaptive Cards, @mention queries, and JWT-verified messaging.",
            },
            {
              icon: (
                <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              title: "Discord",
              description:
                "Bot integration with slash commands, thread-based conversations, and rich embeds for query results.",
            },
            {
              icon: (
                <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            },
            {
              ...
              title: "Webhooks & more",
              description:
                "Webhooks, Google Chat, Telegram, GitHub, Jira, email digest, and Obsidian. Build custom integrations with the plugin SDK.",
            },
          ].map((item) => (
