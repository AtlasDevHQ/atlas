...
description: Unified chat interaction plugin bridging Slack, Teams, Discord, Telegram, Linear, and more into Atlas via Chat SDK adapters.
---
...
| Feature | Slack | Teams | Discord | Google Chat | Telegram | Linear |
|---------|-------|-------|---------|-------------|----------|--------|
| Slash commands | Yes | Yes | Yes | Yes | Yes | No |
| Action buttons | Yes | Yes | Yes | Yes | Partial (inline keyboard) | No |
