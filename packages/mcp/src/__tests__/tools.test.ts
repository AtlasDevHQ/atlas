...
import { registerTools, writeScopeOrNull } from "../tools.js";
...
// ---------------------------------------------------------------------------
// #3504 — `mcp:write` enforcement gate. Formerly `write-scope-gate.test.ts`,
// merged here because `writeScopeOrNull` is exported from the same module
// (`tools.ts`) these suites already drive.
//
// Two layers:
