---
title: Billing & Plans
description: Per-seat pricing tiers, token budgets, overage handling, Stripe setup, and the billing dashboard.
icon: CreditCard
---
...
| Subscription canceled | Downgrades the workspace to free tier |
| Subscription deleted | Downgrades the workspace to free tier |
