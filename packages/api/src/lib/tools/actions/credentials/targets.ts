 ...
 *
 * Pilot (#3766): Jira. GitHub (#5555) and Salesforce (#5556) are the one-entry
 * children it was built for — a spec here plus that target's action, with the
 * resolver, store, Admin route and status surface gaining nothing. They landed
 * from separate lanes and conflicted only as adjacent additions, which is the
 * seam working. Linear (#5554) follows the same way, tracked under #3765.
 */
