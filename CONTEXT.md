...
> multi-context layout ([CONTEXT-MAP.md](CONTEXT-MAP.md)); fifteen of its eighteen contexts
...
>
> They were moved, not copied: no section below duplicates them. The remaining three
