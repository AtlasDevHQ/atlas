...
[CONTEXT.md → Install models](https://github.com/AtlasDevHQ/atlas/blob/main/docs/contexts/install-models/CONTEXT.md)):
...
See the [Integrations admin console](/integrations/admin-console)
